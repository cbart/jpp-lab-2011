...
toList Empty = []
toList (Node p l r) = concat [toList l, [p], toList r]

splay :: Ord k => k -> Dict k v -> Dict k v
splay k Empty = Empty
splay k n1@(Node (k', _) _ _) = case compare k k' of
    EQ -> n1
    o1 -> case node o1 n1 of
        Empty -> n1
        n2@(Node (k'', _) _ _) -> case compare k k'' of
            EQ -> rot1 o1 n1
            o2 -> case node o2 n2 of
                Empty -> rot1 o1 n1
                (Node _ _ _) -> rot2 o1 o2 n1 $ splay k
